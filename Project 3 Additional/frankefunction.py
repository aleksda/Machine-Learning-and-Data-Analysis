...
class Franke:
    ...
    def franke_function(self, random = False, precision = 0.05, noise = False):
        self.noise = noise
        
        x_array, y_array = self.initialize_array(random, precision)
        ...
        if noise:
            ...
            # np.var(normal_dist)
            z = term1 + term2 + term3 + term4 + normal_dist
        else:
